// <copyright file="BrushDefinitions.cs" company="James Jackson-South">
...
namespace ImageSharp.Drawing.Brushes
{
        ...
        where TPacked : struct
    {
        ...
        /// <summary>
        /// Create as brush that will paint a Percent10 Hatch Pattern with in the specified colors
        /// </summary>
        /// <param name="foreColor">Color of the foreground.</param>
        /// <param name="backColor">Color of the background.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Create as brush that will paint a Percent20 Hatch Pattern with in the specified colors
        /// </summary>
        /// <param name="foreColor">Color of the foreground.</param>
        /// <param name="backColor">Color of the background.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Create as brush that will paint a Horizontal Hatch Pattern with in the specified colors
        /// </summary>
        /// <param name="foreColor">Color of the foreground.</param>
        /// <param name="backColor">Color of the background.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Create as brush that will paint a Min Hatch Pattern with in the specified colors
        /// </summary>
        /// <param name="foreColor">Color of the foreground.</param>
        /// <param name="backColor">Color of the background.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Create as brush that will paint a Vertical Hatch Pattern with in the specified colors
        /// </summary>
        /// <param name="foreColor">Color of the foreground.</param>
        /// <param name="backColor">Color of the background.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Create as brush that will paint a Forward Diagonal Hatch Pattern with in the specified colors
        /// </summary>
        /// <param name="foreColor">Color of the foreground.</param>
        /// <param name="backColor">Color of the background.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Create as brush that will paint a Backward Diagonal Hatch Pattern with in the specified colors
        /// </summary>
        /// <param name="foreColor">Color of the foreground.</param>
        /// <param name="backColor">Color of the background.</param>
        /// <returns></returns>
