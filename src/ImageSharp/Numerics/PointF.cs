...
namespace ImageSharp
{
    ...
    public struct PointF : IEquatable<PointF>
    {
        ...
        public float X
        {
            get { return backingVector.X; }
            set { backingVector.X = value; }
        }
        ...
        public float Y
        {
            get { return backingVector.Y; }
            set { backingVector.Y = value; }
        }
        ...
        {
            // should this be a return of the mutable vector2 backing vector of a copy?
